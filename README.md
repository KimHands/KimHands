...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=KimHands&fontSize=60&fontColor=fff&animation=twinkling&fontAlignY=35&desc=Web%20Developer%20%7C%20Likelion%20SCH%2014th&descAlignY=55&descSize=18" width="100%"/>
...
> 사용자 경험을 고민하는 웹 개발자이자, 풀스택 개발과 보안에 관심 많은 개발자입니다.  
> AI 기반 개발 도구와 자동화 워크플로우를 즐겨 활용하며, 꾸준히 성장하는 것을 좋아합니다.

<br/>

| | |
|---|---|
| 🦁 **현 소속** | LIKELION SCH 14th FS 운영진 |
| 🦔 **현 소속** | SCH CSE Hedgehog 동아리원 |
| 🌱 **관심사** | 풀스택 개발 · 보안 취약점 분석 · 암호학 · 바이브코딩 |
...
| 프로젝트 | 설명 | 상태 |
|---|---|:---:|
| 🦁 멋쟁이사자처럼 SCH 웹사이트 | 동아리 공식 홈페이지 개발 및 유지보수 | `진행 중` |
| ⚙️ n8n 자동화 워크플로우 | 설문 제출 · 파일 첨부 · Slack 알림 파이프라인 | `개발 중` |
| 🤖 AI 개발 워크플로우 최적화 | Claude Code + bkit 플러그인 활용 연구 | `실험 중` |
